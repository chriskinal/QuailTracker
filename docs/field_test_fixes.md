...
| R08 | R07 | **SD SPI data clock 5 -> 20 MHz** (`SD_SPI_FAST_PRESCALER` = /8; env `stm32u575_spi10` falls back to 10 MHz) | **PASS 2026-09-21** — 0.19.0 (`42a3e33`). 10 MHz: chunk-1 overruns 1274 -> 0, total 1521 -> 18. 20 MHz clean build: **total 0**. |
