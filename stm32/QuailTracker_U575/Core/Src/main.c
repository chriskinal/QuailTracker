...
void startRecording(void)
{
     ...
     * — and is the leading explanation for the write stalls that cost 58 s and
     * 14 s of audio on the old step-02 runs (docs/field_test_fixes.md). Only
     * meaningful for time-bounded chunks; chunkMinutes==0 has no size to
     * pre-allocate.
     *
